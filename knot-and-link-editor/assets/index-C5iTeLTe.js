...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function gs(e,t,n){let r=new Float32Array(ns),i=new U(0,1,0);return new Na({name:`SphericalGaussianBlur`,defines:{n:ns,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ys(),fragmentShader:`
	...
	`}var bs=class extends on{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ui(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    </label>`,document.body.appendChild(c);let l=c.querySelector(`input`),u=c.querySelector(`output`),d=document.createElement(`i`);e.appendChild(d);let f=i,p=()=>{u.textContent=a(f);let e=(f-t)/(n-t),r=6+Math.round(e*13);d.style.width=`${r}px`,d.style.height=`${r}px`},m=(e,t=!0)=>{f=Number(e),l.value=f,p(),t&&s(f)};return l.addEventListener(`input`,()=>m(l.value)),e.addEventListener(`click`,()=>Ld(e,c)),m(i,!1),{get:()=>f,set:e=>m(e,!1),show:()=>{Fd?.swatch!==e&&Ld(e,c)},el:c}}var Vd=`knot-a-problem/scene`,Hd=`.knot.json`,Ud=5,Wd=2e3,Gd=2e5,Kd=/^#[0-9a-f]{6}$/i,qd=e=>+e.toFixed(Ud),Jd=e=>typeof e==`number`&&Number.isFinite(e);function Yd(e,{camera:t=null,by:n=`human`}={}){return{format:Vd,version:1,saved:new Date().toISOString(),by:n,...t?{camera:{position:t.position.map(qd),target:t.target.map(qd)}}:{},curves:e.map(e=>({name:e.name,color:e.color,radius:qd(e.radius),closed:!!e.closed,by:e.by??`human`,points:e.points.map(e=>[qd(e[0]),qd(e[1]),qd(e[2])])}))}}function Xd(e){let t=e.curves.map(e=>{let t=JSON.stringify({name:e.name,color:e.color,radius:e.radius,closed:e.closed,by:e.by}),n=e.points.map(e=>`      ${JSON.stringify(e)}`).join(`,
`);return`    { ${t.slice(1,-1)},\n      "points": [\n${n}\n      ]\n    }`}).join(`,
`),n={...e};return delete n.curves,`{\n${Object.entries(n).map(([e,t])=>`  ${JSON.stringify(e)}: ${JSON.stringify(t)}`).join(`,
`)},\n  "curves": [\n${t}\n  ]\n}\n`}function Zd(e,{fallbackColor:t=`#d2d24b`,defaultRadius:n=.075}={}){let r;try{r=JSON.parse(e)}catch{throw Error(`that file is not JSON`)}if(!r||typeof r!=`object`||Array.isArray(r))throw Error(`that file is not a scene`);if(r.format!==`knot-a-problem/scene`)throw Error(`that file is not a knot scene (no "${Vd}" tag)`);if(!Number.isInteger(r.version)||r.version<1)throw Error(`that scene has no version`);if(r.version>1)throw Error(`that scene was written by a newer version (${r.version} > 1)`);if(!Array.isArray(r.curves))throw Error(`that scene has no curves`);if(r.curves.length>Wd)throw Error(`that scene has too many curves (${r.curves.length})`);let i=0,a=[];return r.curves.forEach((e,r)=>{if(!e||typeof e!=`object`||!Array.isArray(e.points))throw Error(`curve ${r+1} has no points`);if(i+=e.points.length,i>Gd)throw Error(`that scene has too many points to load`);let o=e.points.map((e,t)=>{if(!Array.isArray(e)||e.length!==3||!e.every(Jd))throw Error(`curve ${r+1}, point ${t+1} is not three numbers`);return[e[0],e[1],e[2]]});if(o.length<2)throw Error(`curve ${r+1} has fewer than two points`);a.push({name:typeof e.name==`string`&&e.name?e.name.slice(0,120):`curve ${r+1}`,color:typeof e.color==`string`&&Kd.test(e.color)?e.color:t,radius:Jd(e.radius)&&e.radius>0?e.radius:n,closed:!!e.closed,by:typeof e.by==`string`?e.by.slice(0,40):`human`,points:o})}),{curves:a,camera:Qd(r.camera),by:typeof r.by==`string`?r.by:null}}function Qd(e){let t=e=>Array.isArray(e)&&e.length===3&&e.every(Jd);return!e||typeof e!=`object`||!t(e.position)||!t(e.target)?null:{position:[...e.position],target:[...e.target]}}function $d(e){let t=[1/0,1/0,1/0],n=[-1/0,-1/0,-1/0],r=!1;for(let i of e)for(let e of i.points){r=!0;for(let r=0;r<3;r++)e[r]<t[r]&&(t[r]=e[r]),e[r]>n[r]&&(n[r]=e[r])}return r?{lo:t,hi:n,centre:[0,1,2].map(e=>(t[e]+n[e])/2),size:[0,1,2].map(e=>n[e]-t[e])}:null}function ef(e,t){return(Math.abs(e[0]*t[0])+Math.abs(e[1]*t[1])+Math.abs(e[2]*t[2]))/2}function tf(e,t,n,r=.25){let i=$d(e),a=$d(t);if(!i||!a)return[0,0,0];let o=Math.hypot(...n)||1,s=n.map(e=>e/o),c=ef(i.size,s)+ef(a.size,s),l=r*Math.max(...a.size),u=e=>e[0]*s[0]+e[1]*s[1]+e[2]*s[2],d=u(i.centre)-u(a.centre)+c+l;return s.map(e=>e*d)}function nf(e,t){return t.every(e=>e===0)?e:e.map(e=>({...e,points:e.points.map(e=>[e[0]+t[0],e[1]+t[1],e[2]+t[2]])}))}function rf(e,t,n){let r=af(t,n),i=Math.hypot(...r),a=of(t,n);if(i<1e-9)return a>0?e:rf(e,t,sf(af(t,Math.abs(t[0])<.9?[1,0,0]:[0,1,0])));let o=r.map(e=>e/i),s=Math.atan2(i,a),c=Math.cos(s),l=Math.sin(s),u=$d(e)?.centre??[0,0,0],d=e=>{let t=[e[0]-u[0],e[1]-u[1],e[2]-u[2]],n=af(o,t),r=of(o,t)*(1-c);return[0,1,2].map(e=>u[e]+t[e]*c+n[e]*l+o[e]*r)};return e.map(e=>({...e,points:e.points.map(d)}))}var af=(e,t)=>[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]],of=(e,t)=>e[0]*t[0]+e[1]*t[1]+e[2]*t[2],sf=e=>{let t=Math.hypot(...e)||1;return e.map(e=>e/t)};function cf(e){let t=[`# knot-a-problem`,`# ${e.length} curve(s)`],n=1;for(let r of e){t.push(`o ${(r.name||`curve`).replace(/\s+/g,`_`)}`);for(let e of r.points)t.push(`v ${e.map(e=>+e.toFixed(6)).join(` `)}`);let e=r.points.map((e,t)=>n+t);r.closed&&e.push(n),t.push(`l ${e.join(` `)}`),n+=r.points.length}return t.join(`
`)+`
`}function lf(e){let t=e.map(e=>e.closed?-e.points.length:e.points.length),n=e.reduce((e,t)=>e+t.points.length,0),r=[`VECT`,`${e.length} ${n} ${e.length}`,t.join(` `),e.map(()=>1).join(` `)];for(let t of e)for(let e of t.points)r.push(e.map(e=>+e.toFixed(6)).join(` `));for(let t of e){let[e,n,i]=uf(t.color);r.push(`${e.toFixed(4)} ${n.toFixed(4)} ${i.toFixed(4)} 1`)}return r.join(`
`)+`
`}function uf(e){if(!Kd.test(e??``))return[1,1,1];let t=parseInt(e.slice(1),16);return[t>>16&255,t>>8&255,t&255].map(e=>e/255)}function df(e=new Date){let t=e=>String(e).padStart(2,`0`);return`knot-${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}-${t(e.getHours())}${t(e.getMinutes())}`}var ff=`modulepreload`,pf=function(e,t){return new URL(e,t).href},mf={},hf=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=pf(t,n),t=s(t),t in mf)return;mf[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:ff,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},gf=document.getElementById(`view`),_f=document.getElementById(`status`),vf=document.getElementById(`help`),yf=document.getElementById(`eraser-cursor`),X=e=>document.getElementById(e),Z=new l,Q=new Pu(gf),bf=`select`,$=new Set,xf=null,Sf=null,Cf=new Set,wf=!1,Tf=i,Ef=a,Df=.06,Of=null,kf=null,Af=null,jf=20,Mf=5,Nf=7,Pf=e=>4*e;function Ff(){return cp()?.radius??Ef}function If(){return Pf(Ff())/Q.worldPerPixel()}function Lf(){return If()/2}function Rf(){return 2.5*If()}function zf(e){let t=0;for(let n=1;n<e.length;n++)t+=Math.hypot(e[n][0]-e[n-1][0],e[n][1]-e[n-1][1]);return t}function Bf(e){if(e.length!==2)return e;let[t,n]=e;return[t,[(t[0]+n[0])/2,(t[1]+n[1])/2,(t[2]+n[2])/2],n]}var Vf=[],Hf=[],Uf=80,Wf=0;function Gf(){Wf>0||(Of=null,Vf.push(Z.toJSON()),Vf.length>Uf&&Vf.shift(),Hf.length=0,Qf())}function Kf(){Wf===0&&Gf(),Wf++}function qf(){Wf=Math.max(0,Wf-1),Wf===0&&(ip(),Qf())}function Jf(){return Wf!==0&&(Wf=0,Vf.length&&Z.restore(Vf.pop()),Zf(`reverted`),!0)}function Yf(){Vf.length&&(Hf.push(Z.toJSON()),Z.restore(Vf.pop()),Zf(`undo`))}function Xf(){Hf.length&&(Vf.push(Z.toJSON()),Z.restore(Hf.pop()),Zf(`redo`))}function Zf(e){Of=null,Sf=null,Q.clearPreview(),xf&&!Z.get(xf)&&(xf=null),Q.liveId=xf,ip(),ep(xf?[xf]:[]),sp(e)}function Qf(){X(`btn-undo`).disabled=Vf.length===0,X(`btn-redo`).disabled=Hf.length===0}function $f(e){Sf=null,Of=null,Id(),Q.clearPreview(),up(),bf=e,Q.setTool(e);for(let t of document.querySelectorAll(`#toolbar .tool`))t.classList.toggle(`active`,t.dataset.tool===e);X(`sc-erase`).hidden=e!==`erase`,X(`sc-draw`).hidden=e!==`draw`,yf.hidden=e!==`erase`,yf.classList.toggle(`disabled`,e===`erase`&&$.size===0),tp(),ap()}function ep(e){$=new Set(e),Q.setSelection($),$=Q.selection,Of&&!Vp($,Of.ids)&&(Of=null),Q.updateHandles(Z),X(`btn-delete`).disabled=$.size===0,X(`btn-smooth`).disabled=$.size===0,yf.classList.toggle(`disabled`,bf===`erase`&&$.size===0),tp(),ap()}function tp(){let e=[...$].map(e=>Z.get(e)).filter(Boolean);for(let[t,n]of[[`sw-draw-color`,bf===`draw`],[`sw-draw-size`,bf===`draw`],[`sw-sel-color`,bf===`select`&&e.length>0],[`sw-sel-size`,bf===`select`&&e.length>0],[`sw-erase-size`,bf===`erase`]])X(t).hidden=!n;e.length&&(nm.set(e[0].color),rm.set(e[0].radius??a))}function np(){let e=r.indexOf(Tf);e>=0&&em.set(r[(e+1)%r.length]),Tf=em.get()}function rp(e){let t=[...$].map(e=>Z.get(e)).filter(Boolean);if(t.length){Gf();for(let n of t)Object.assign(n,e);ip()}}function ip(){Q.syncCurves(Z),ep($),Qf()}function ap(){let e=Z.curves.length,t=`<b>${e}</b> curve${e===1?``:`s`}`,n;n=bf===`draw`?wf?`<b>under</b> &mdash; this stretch dives beneath whatever it crosses`:xf?`continuing · every gap you leave goes under · come back to the other end to close`:`draw · lift the pen, or hold <b>U</b>, wherever the strand passes under`:bf===`erase`?$.size?`rub to erase from <b>${$.size}</b> selected · size <b>${jf}</b>px`:`select a strand first — the eraser only touches what you pick`:$.size?`<b>${$.size}</b> selected · drag an end to continue it · Del to remove`:e===0?`press <b>D</b> and sweep a loop`:e===1?`drag to orbit &mdash; you draw on the plane facing you`:`drag to orbit · click a strand to select`,_f.innerHTML=`${t} &nbsp;&middot;&nbsp; ${n}`}var op=null;function sp(e){_f.innerHTML=e,clearTimeout(op),op=setTimeout(ap,2400)}function cp(){return xf?Z.get(xf):null}function lp(e,t=`end`){let n=Z.get(e);n&&t===`start`&&(Gf(),n.points.reverse()),xf=n?e:null,Q.liveId=xf,ep(xf?[xf]:[])}function up(){xf&&(xf=null,Q.liveId=null,ep([]))}function dp(){xf&&np(),up(),bf===`select`?ap():$f(`select`)}function fp(){let e=[];for(let t of Z.curves){let n=Q.projectCurve(t);t.id===xf&&(n.length=Math.max(0,n.length-2)),n.length>1&&e.push(n)}return e}function pp(){let e=Vu(Sf??[],2);return e.length<2||zf(e)<Nf?null:Wu(e,6,4)}function mp(e){let t=[e.clientX,e.clientY];return wf&&Cf.add(t),t}function hp(){let e=Vu(Sf??[],2);if(e.length<2)return Q.clearPreview();let t=e.map(([e,t])=>Q.unproject(e,t)).filter(Boolean);t.length>=2&&Q.showPreview(t,!1)}function gp(e,t=new Set){let n=cp(),r=n?Q.project(Fu(n.points[0])):e[0],i=e,a=e.map(e=>t.has(e)),o=0;if(n){let t=Fu(n.points[n.points.length-1]),r=td(Q.project(t),e[0],Lf());i=[...r,...e],a=[...r.map(()=>!0),...a],o=Q.depthOf(t)}let s=e[e.length-1],c=Math.hypot(s[0]-r[0],s[1]-r[1])<Rf();if(c){let e=td(s,r,Lf());i=[...i,...e],a=[...a,...e.map(()=>!0)]}let l=nd(i,a,{startDepth:o,separation:If(),obstacles:fp()}),u=l.points.map(([e,t,n])=>Q.unproject(e,t,n)).filter(Boolean).map(e=>[e.x,e.y,e.z]);u.length<2||(Gf(),n?(n.points.push(...u),n.closed=c):xf=Z.addCurve(Bf(u),{closed:c,color:Tf,radius:Ef}).id,Q.clearPreview(),ip(),c?dp():(Q.liveId=xf,ep([xf])),_p(l,c))}function _p({crossings:e,under:t},n){let r=e?`<b>${e}</b> crossing${e===1?``:`s`}`:``;if(n)return sp(e?`${r} — the strand is a loop`:`the strand is a loop`);e&&sp(t===e?`${r}, all passing under — orbit to check`:`${r}, <b>${e-t}</b> passed over — lift the pen there to go under instead`)}function vp(){let e=pp(),t=Cf;if(Sf=null,Cf=new Set,Q.clearPreview(),!e)return dp();gp(e,t)}function yp(e){return $.size?(Gf(),kf={session:new Ju(Z,Q,$),queued:!1},gf.setPointerCapture(e.pointerId),bp(e),!0):(sp(`select a strand first — the eraser only touches what you pick`),!1)}function bp(e){kf.session.rub(e.clientX,e.clientY,jf),!kf.queued&&(kf.queued=!0,requestAnimationFrame(()=>{kf&&(kf.queued=!1,kf.session.apply()&&ip())}))}function xp(){kf.session.apply()&&ip(),kf=null}addEventListener(`pointerdown`,e=>{if(e.button!==0||e.target!==gf||bf===`erase`)return;let t=Q.hitHandle(e.clientX,e.clientY);t&&(e.stopPropagation(),e.preventDefault(),$f(`draw`),lp(t.curveId,t.end),Af=[e.clientX,e.clientY],Sf=[mp(e)],gf.setPointerCapture(e.pointerId))},!0),gf.addEventListener(`pointerdown`,e=>{e.button===0&&(Af=[e.clientX,e.clientY],Q.setDragging(!0),bf===`draw`?(Sf=[mp(e)],gf.setPointerCapture(e.pointerId)):bf===`erase`&&yp(e))}),gf.addEventListener(`pointermove`,e=>{bf===`erase`&&(yf.style.left=`${e.clientX}px`,yf.style.top=`${e.clientY}px`),bf!==`erase`&&Q.setHotHandle(Q.hitHandle(e.clientX,e.clientY,Rf())),Sf?(e.shiftKey?Sf=[Sf[0],mp(e)]:Sf.push(mp(e)),hp()):kf&&bp(e)}),gf.addEventListener(`pointerup`,e=>{if(e.button!==0)return;Q.setDragging(!1);let t=Af&&Math.hypot(e.clientX-Af[0],e.clientY-Af[1]);if(Af=null,Sf)gf.releasePointerCapture(e.pointerId),vp();else if(kf)gf.releasePointerCapture(e.pointerId),xp();else if(bf===`select`&&t!==null&&t<Mf){let t=Q.pick(e.clientX,e.clientY);if(!t)ep(e.shiftKey?$:[]);else if(!e.shiftKey)ep([t]);else{let e=new Set($);e.has(t)?e.delete(t):e.add(t),ep(e)}}}),gf.addEventListener(`pointercancel`,()=>{Q.setDragging(!1),kf=null,Af=null,Sf=null,Q.clearPreview()});var Sp=X(`drop-hint`),Cp=0,wp=e=>[...e.dataTransfer?.types??[]].includes(`Files`);addEventListener(`dragenter`,e=>{wp(e)&&(e.preventDefault(),Cp++,Sp.hidden=!1)}),addEventListener(`dragover`,e=>{wp(e)&&e.preventDefault()}),addEventListener(`dragleave`,()=>{--Cp<=0&&(Cp=0,Sp.hidden=!0)}),addEventListener(`drop`,e=>{wp(e)&&(e.preventDefault(),Cp=0,Sp.hidden=!0,Pp([...e.dataTransfer.files]))}),gf.addEventListener(`contextmenu`,e=>e.preventDefault());var Tp=document.getElementById(`confirm`),Ep=null;function Dp(e,{confirm:t=`Delete`,danger:n=!0}={}){document.getElementById(`confirm-text`).innerHTML=e;let r=X(`confirm-yes`);return r.textContent=t,r.classList.toggle(`danger`,n),Tp.hidden=!1,r.focus(),new Promise(e=>{Ep=e})}function Op(e){Tp.hidden=!0,Ep?.(e),Ep=null}X(`confirm-yes`).addEventListener(`click`,()=>Op(!0)),X(`confirm-no`).addEventListener(`click`,()=>Op(!1)),Tp.addEventListener(`click`,e=>{e.target===Tp&&Op(!1)});var kp=Object.assign({"./library/borromean.knot.json":()=>hf(()=>import(`./borromean.knot-nk0bmJrh.js`),[],import.meta.url),"./library/cinquefoil.knot.json":()=>hf(()=>import(`./cinquefoil.knot-D4syUGR-.js`),[],import.meta.url),"./library/circle.knot.json":()=>hf(()=>import(`./circle.knot-B9OSLsAp.js`),[],import.meta.url),"./library/figure-eight.knot.json":()=>hf(()=>import(`./figure-eight.knot-DKFvYxiI.js`),[],import.meta.url),"./library/hopf-link.knot.json":()=>hf(()=>import(`./hopf-link.knot-DogVDDzC.js`),[],import.meta.url),"./library/pentagon.knot.json":()=>hf(()=>import(`./pentagon.knot-7-qwk2HG.js`),[],import.meta.url),"./library/solomon.knot.json":()=>hf(()=>import(`./solomon.knot-Vc1qp86b.js`),[],import.meta.url),"./library/square.knot.json":()=>hf(()=>import(`./square.knot-pUnzsEC9.js`),[],import.meta.url),"./library/torus-3-4.knot.json":()=>hf(()=>import(`./torus-3-4.knot-C7tsMQq8.js`),[],import.meta.url),"./library/trefoil.knot.json":()=>hf(()=>import(`./trefoil.knot-CrLO2SBc.js`),[],import.meta.url),"./library/triangle.knot.json":()=>hf(()=>import(`./triangle.knot-Cz_PxSHU.js`),[],import.meta.url)});function Ap(){return Yd(Z.curves,{camera:Q.camera3()})}function jp(e,t,n=`application/json`){let r=URL.createObjectURL(new Blob([t],{type:n})),i=document.createElement(`a`);i.href=r,i.download=e,i.click(),setTimeout(()=>URL.revokeObjectURL(r),1e3)}async function Mp(){if(!Z.curves.length)return sp(`nothing to save yet`);let e=Xd(Ap()),t=Z.curves.length,n=e.length<1024?`${e.length} bytes`:`${(e.length/1024).toFixed(1)} KB`;await Dp(`Save <b>${t}</b> curve${t===1?``:`s`} to a file? <br><small>${n}</small>`,{confirm:`Save`,danger:!1})&&(jp(df()+Hd,e),sp(`saved <b>${t}</b> curve${t===1?``:`s`} &nbsp;&middot;&nbsp; ${n}`))}function Np({curves:e,camera:t},{face:n=!1,label:r=`loaded`}={}){if(!e.length)return sp(`that file has no curves in it`);let i=Z.curves.length===0,a=e;n&&(a=rf(a,[0,0,1],Q.forward().map(e=>-e))),a=nf(a,tf(Z.curves,a,Q.right())),Gf();let o=a.map(e=>Z.addCurve(e.points,{closed:e.closed,color:e.color,radius:e.radius,name:e.name}));ip(),ep(o.map(e=>e.id));let s=$d(a);i&&t&&!n?Q.setCamera(t):s&&Q.easeTo(s.centre,Math.max(...s.size)/2);let c=o.length;sp(`${r} &nbsp;&middot;&nbsp; <b>${c}</b> curve${c===1?``:`s`}`)}async function Pp(e){for(let t of e)try{Np(Zd(await t.text(),{fallbackColor:Tf,defaultRadius:a}),{label:t.name})}catch(e){sp(`<b>${t.name}</b> &mdash; ${e.message}`);return}}async function Fp(e){let t=kp[`./library/${e}`];if(!t)return sp(`that shape is missing from the library`);let n=await t();Np(Zd(JSON.stringify(n.default??n)),{face:!0,label:`inserted`})}var Ip=320,Lp=120,Rp=.4,zp=e=>Math.min(1,Math.max(0,e/Rp))**2,Bp=e=>3*e,Vp=(e,t)=>e.size===t.length&&t.every(t=>e.has(t));function Hp(e,t=Ip){let n=zu(e,t).map(e=>[e.x,e.y,e.z]);return e.closed&&n.length&&n.push(n[0]),n}function Up(){let e=[...$].map(e=>Z.get(e)).filter(Boolean);if(!e.length)return sp(`select a strand first — smoothing works on what you pick`);Gf(),Of={ids:e.map(e=>e.id),was:new Map(e.map(e=>[e.id,structuredClone(e.points)]))},Wp(),im.show()}function Wp(){if(!Of)return;for(let[e,t]of Of.was){let n=Z.get(e);n&&(n.points=structuredClone(t))}let e=zp(Df),t=1+Math.round(2*e),n=0,r=0;for(let i=0;i<t;i++){n=0,r=0;for(let t of Of.ids){let i=Z.get(t);if(!i||i.points.length<3||Df<=0)continue;let o=Hp(i);if(i.closed&&o.pop(),o.length<4)continue;let s=xd(o,{closed:i.closed,amount:Df,obstacles:Z.curves.filter(e=>e!==i).map(e=>Hp(e,Lp)).filter(e=>e.length>1),minGap:Bp(i.radius??a),spread:e});s.points.length>=(i.closed?3:2)&&(i.points=s.points),n+=s.blocked,r++}}ip();let i=Of.ids.length,o=`<b>${i}</b> strand${i===1?``:`s`}`;if(!r)return sp(`${o} &nbsp;&middot;&nbsp; back to how you drew ${i===1?`it`:`them`}`);sp(`smoothed ${o} &nbsp;&middot;&nbsp; ${n?`held back where they cross`:`slide to taste`}`)}var Gp=!1;function Kp(){!Of||Gp||(Gp=!0,requestAnimationFrame(()=>{Gp=!1,Wp()}))}async function qp(){if($.size&&!($.size>1&&!await Dp(`Delete <b>${$.size}</b> selected curves?`))){Gf();for(let e of $)Z.remove(e);ep([]),ip()}}function Jp(e){jf=Math.max(6,Math.min(90,e)),yf.style.width=`${jf*2}px`,yf.style.height=`${jf*2}px`,am?.set(jf),ap()}function Yp(){Q.frameAll(Z)}for(let e of document.querySelectorAll(`#toolbar .tool`))e.addEventListener(`click`,()=>$f(e.dataset.tool));X(`btn-undo`).addEventListener(`click`,Yf),X(`btn-redo`).addEventListener(`click`,Xf),X(`btn-smooth`).addEventListener(`click`,Up),X(`btn-delete`).addEventListener(`click`,qp),X(`btn-help`).addEventListener(`click`,()=>vf.classList.toggle(`hidden`)),X(`btn-save`).addEventListener(`click`,Mp),X(`btn-open`).addEventListener(`click`,()=>X(`file-input`).click()),X(`file-input`).addEventListener(`change`,e=>{Pp([...e.target.files]),e.target.value=``}),X(`help-close`).addEventListener(`click`,()=>vf.classList.add(`hidden`));var Xp=new Set([`Meta`,`Control`,`Shift`]);addEventListener(`keydown`,e=>{if(Xp.has(e.key)&&Q.setPanHint(!0),(e.key===`u`||e.key===`U`)&&(wf=!0,ap()),e.metaKey||e.ctrlKey){let t=e.key.toLowerCase();t===`z`?(e.preventDefault(),e.shiftKey?Xf():Yf()):t===`y`?(e.preventDefault(),Xf()):t===`s`?(e.preventDefault(),Mp()):t===`o`?(e.preventDefault(),X(`file-input`).click()):t===`a`&&(e.preventDefault(),ep(Z.curves.map(e=>e.id)));return}if(e.altKey)return;if(!Tp.hidden){e.key===`Escape`?Op(!1):e.key===`Enter`&&Op(!0);return}let t=e.key;t===`Escape`?(vf.classList.contains(`hidden`)||vf.classList.add(`hidden`),kf=null,Sf=null,Q.clearPreview(),xf||bf!==`select`?dp():ep([])):t===`Enter`?dp():t===`d`||t===`D`?$f(`draw`):t===`s`||t===`S`?$f(`select`):t===`e`||t===`E`?$f(`erase`):t===`f`||t===`F`?Yp():t===`m`||t===`M`?Up():t===`Delete`||t===`Backspace`?(e.preventDefault(),qp()):t===`[`?Jp(jf-4):t===`]`?Jp(jf+4):t===`?`?vf.classList.toggle(`hidden`):(t===`a`||t===`A`)&&ep(Z.curves.map(e=>e.id))}),addEventListener(`keyup`,e=>{Xp.has(e.key)&&Q.setPanHint(!1),(e.key===`u`||e.key===`U`)&&(wf=!1,ap())}),addEventListener(`blur`,()=>{Q.setPanHint(!1),wf=!1});var Zp=a*2,Qp=a/20,$p=e=>`${(e/a).toFixed(2)}×`,em=Rd(X(`sw-draw-color`),e=>{Tf=e}),tm=Bd(X(`sw-draw-size`),{min:a/2,max:Zp,step:Qp,value:a,format:$p},e=>{Ef=e}),nm=Rd(X(`sw-sel-color`),e=>rp({color:e})),rm=Bd(X(`sw-sel-size`),{min:a/2,max:Zp,step:Qp,value:a,format:$p},e=>rp({radius:e})),im=Bd(X(`sw-smooth`),{min:0,max:Rp,step:.01,value:Df,label:`Amount`,format:e=>`${Math.round(e*100)}%`},e=>{Df=e,Kp()}),am=Bd(X(`sw-erase-size`),{min:6,max:90,step:2,value:jf,format:e=>`${e}px`},e=>Jp(e));function om(e){im.set(e),Df=im.get(),Wp()}zd(X(`sw-export`),[{title:`Export a copy`,items:[{id:`obj`,title:`Wavefront OBJ`,note:`.obj`},{id:`vect`,title:`Geomview VECT`,note:`.vect`}]}],e=>{if(!Z.curves.length)return sp(`nothing to export yet`);let t=df();e===`obj`?jp(`${t}.obj`,cf(Z.curves),`text/plain`):jp(`${t}.vect`,lf(Z.curves),`text/plain`),sp(`exported as <b>${e.toUpperCase()}</b> &nbsp;&middot;&nbsp; curves only, no thickness`)});var sm=[[`shape`,`Shapes`],[`knot`,`Knots`],[`link`,`Links`]].map(([e,t])=>({title:t,items:u.shapes.filter(t=>t.kind===e).map(e=>({id:e.file,title:e.title,note:e.note}))})).filter(e=>e.items.length);zd(X(`btn-library`),sm,Fp),/Mac/i.test(navigator.platform||``)||(X(`sc-pan`).textContent=`Ctrl drag`),Jp(jf),$f(`select`),ep([]),Qf(),(function e(){requestAnimationFrame(e),Q.render()})();var cm=e=>e==null?[...$]:Array.isArray(e)?e:[e],lm=e=>({id:e.id,name:e.name,color:e.color,radius:e.radius,closed:e.closed,by:e.by??`human`,points:structuredClone(e.points)});globalThis.knot={version:1,scene:{list:()=>Z.curves.map(({points:e,...t})=>({...t,points:e.length})),get:e=>{let t=Z.get(e);return t?lm(t):null},add(e,t={}){if(!Array.isArray(e)||e.length<2)throw Error(`a curve needs at least two points`);Gf();let n=Z.addCurve(structuredClone(e),{by:`agent`,...t});return ip(),n.id},update(e,t={}){let n=Z.get(e);if(!n)return!1;Gf();let{points:r,...i}=t;return Object.assign(n,i,r?{points:structuredClone(r)}:{},{by:t.by??`agent`}),ip(),!0},remove(e){Gf();let t=cm(e).filter(e=>Z.remove(e)).length;return ep([]),ip(),t},clear(){let e=Z.curves.length;return Gf(),Z.clear(),ep([]),ip(),e},toJSON:()=>Yd(Z.curves,{camera:Q.camera3()}),load(e,{face:t=!1}={}){let n=Zd(typeof e==`string`?e:JSON.stringify(e));return Np(n,{face:t,label:`loaded`}),n.curves.length}},select:{get:()=>[...$],set:e=>(ep(cm(e)),[...$]),add:e=>(ep([...$,...cm(e)]),[...$]),all:()=>(ep(Z.curves.map(e=>e.id)),[...$]),none:()=>(ep([]),[])},tool:{get:()=>bf,set(e){if(![`select`,`draw`,`erase`].includes(e))throw Error(`no such tool: ${e}`);return $f(e),bf},settings(e){return e?.color&&(em.set(e.color),Tf=e.color),e?.radius>0&&(tm.set(e.radius),Ef=e.radius),e?.eraser>0&&Jp(e.eraser),{color:Tf,radius:Ef,eraser:jf}}},edit:{smooth(e=Df,t){let n=cm(t);return n.length?(Kf(),ep(n),Up(),om(e),Of=null,qf(),n.length):0}},history:{undo:Yf,redo:Xf,begin:Kf,commit:qf,rollback:Jf,depth:()=>Wf,canUndo:()=>Vf.length>0,canRedo:()=>Hf.length>0},view:{frameAll:Yp,get:()=>Q.camera3(),set:e=>Q.setCamera(e),moveTo(e){let t=Z.get(e);if(!t)return!1;let n=$d([t]);return Q.easeTo(n.centre,Math.max(...n.size)/2),!0}},library:{list:()=>u.shapes.map(({file:e,title:t,note:n,kind:r,parts:i})=>({name:e.replace(/\.knot\.json$/,``),title:t,note:n,kind:r,parts:i})),load:e=>Fp(e.endsWith(`.knot.json`)?e:e+Hd)},file:{save:Mp,export(e=`obj`){if(!Z.curves.length)return null;let t=e===`vect`?lf(Z.curves):cf(Z.curves);return jp(`${df()}.${e}`,t,`text/plain`),t.length}},internals:{model:Z,viewer:Q,refresh:ip,setSmooth:om}};